...
var (
	...
	flagAgentAddress = flag.String("agent-listen-address", "localhost:7773", "Address where the agent http server runs. Must be a valid callback url for the oauth2 application.")
